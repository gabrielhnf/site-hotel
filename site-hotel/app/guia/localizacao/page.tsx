...
const Localizacao = () => {
    ...
    return(
        <div className="relative flex h-[calc(100vh_-_4rem)] sm:h-[calc(100vh_-_5rem)]">
            <div className="relative w-full mx-2 sm:w-2/3 h-[60%] sm:h-[70%] lg:h-[75%] xl:h-[90%] sm:mx-auto mb-auto mt-10 sm:my-auto flex flex-col items-center bg-[#ffffff] rounded-2xl shadow-2xl py-4 pt-10 gap-y-5 justify-between" style={{animation: "pulseIn 0.5s ease-in-out"}}>
                <h1 className="text-4xl lg:text-4xl text-[#754927] font-brittany font-medium">Localização</h1>
                ...
                <div className="w-full px-5 pb-3 sm:pb-0 h-1/3 xl:h-[50%]">
                    <div className="flex flex-row w-full h-full gap-x-5 items-end overflow-auto rounded-lg">
                        ...
                        className="w-1/3 h-full rounded-lg flex-grow-[1]"></iframe>
            ...
            <button className="w-fit h-fit" onClick={() => redirect("/guia")}>
                <Image src={closebrown} alt="Voltar" className="absolute top-5 right-5 h-[1.5rem] sm:h-[2.5rem] w-fit"/>
            </button>
